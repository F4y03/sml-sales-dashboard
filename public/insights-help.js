(() => {
  const topics = {
    ...
    watch: {
      ...
      notes: [['อ่านแท่งคู่', 'สีทองคือยอดสุทธิช่วงก่อน สีแดงไวน์คือช่วงนี้ ใช้สเกลเดียวกันสำหรับสินค้าทั้ง 5 อันดับภายในกราฟนี้ ถ้ายอดเป็นศูนย์จะไม่มีความยาวแท่ง และถ้าติดลบแท่งจะอยู่ทางซ้ายของเส้นศูนย์'], ['จัดอันดับด้วยมูลค่า', 'เรียงส่วนต่างเป็นบาทจากมากไปน้อย ไม่ได้เรียงตามเปอร์เซ็นต์ที่ลดลง สเกลอาจต่างจากกราฟสินค้าขายดี'], ['สินค้าใดเข้ากลุ่มนี้', 'เฉพาะสินค้าที่ช่วงก่อนมียอดสุทธิเป็นบวกและช่วงนี้ยอดน้อยลง คลิกสินค้าเพื่อดูรายละเอียดก่อนสรุปสาเหตุ']]
    }
  };
