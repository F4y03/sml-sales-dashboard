...
กรอกชื่อผู้ใช้และรหัสผ่านอย่างน้อย 12 ตัวอักษร ไม่เกิน 72 UTF-8 bytes (ซ่อนขณะพิมพ์) คำสั่งเก็บ bcrypt hash ใน `data/access.sqlite` ซึ่งถูกละเว้นจาก Git ไม่แก้ `.env` หรือฐาน SML ใช้คำสั่งเดิมเพื่อกู้บัญชี Super Admin หรือรีเซ็ตรหัสผ่าน เซสชันเดิมของบัญชีนั้นจะถูกยกเลิก
